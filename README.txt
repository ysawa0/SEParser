...
2. 
Make sure englishPCFG.ser.gz the Stanford Parser model file is in the base directory.
It can be downloaded from: http://nlp.stanford.edu/software/lex-parser.shtml#Download
